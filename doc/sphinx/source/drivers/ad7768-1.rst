...
The AD7768-1 is a precision 24-bit analog-to-digital converter (ADC)
...
+=================+=========================+===================+=========================+
| Continuous      | Uninterrupted data      | AD77681_CONV_     | Real-time sound         |
|                 | conversion, ideal for   | CONTINUOUS        | measurement.            |
|                 | continuous signal       |                   |                         |
|                 | monitoring.             |                   |                         |
+-----------------+-------------------------+-------------------+-------------------------+
| One-shot        | Single conversion on    | AD77681_CONV_     | Intermittent readings   |
|                 | demand, suitable for    | ONE_SHOT          | in battery-powered      |
|                 | low-power applications. |                   | devices.                |
+-----------------+-------------------------+-------------------+-------------------------+
| Periodic        | Converts data at        | AD77681_CONV_     | Environmental           |
|                 | regular intervals,      | PERIODIC          | monitoring with         |
|                 | balancing power         |                   | scheduled readings.     |
|                 | consumption and         |                   |                         |
|                 | performance.            |                   |                         |
+-----------------+-------------------------+-------------------+-------------------------+
| Standby         | Low-power state, ready  | AD77681_CONV_     | Devices needing quick   |
|                 | for quick conversion    | STANDBY           | wake-up capability.     |
|                 | resumption.             |                   |                         |
+-----------------+-------------------------+-------------------+-------------------------+
| Single          | Similar to one-shot but | AD77681_CONV_     | Single event            |
|                 | implied more for        | SINGLE            | measurement and         |
|                 | one-time single use     |                   | precision testing.      |
|                 | without a signal.       |                   |                         |
+-----------------+-------------------------+-------------------+-------------------------+
