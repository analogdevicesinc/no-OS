...
In order for proper installation of the MSYS2 GCC one should follow the official guide : https://www.msys2.org/
After GCC is fully and correctly installed, its location must be well known, and
the $PATH environment variable needs to be set using Git Bash, i. e. :

    .. code-block::
        
        $ export PATH=/c/msys64/mingw64/bin:$PATH

To test if the compiler is set, one might run :
