...
EXTRA_LIBS_PATHS		+= $(NO-OS)/libraries/azure-sdk-for-c/build/sdk/src/azure/iot/
EXTRA_LIBS_PATHS		+= $(NO-OS)/libraries/azure-sdk-for-c/build/sdk/src/azure/platform/
EXTRA_LIBS_PATHS		+= $(NO-OS)/libraries/azure-sdk-for-c/build/sdk/src/azure/core/
EXTRA_LIBS			+= $(NO-OS)/libraries/azure-sdk-for-c/build/sdk/src/azure/iot/libaz_iot_hub.a
EXTRA_LIBS			+= $(NO-OS)/libraries/azure-sdk-for-c/build/sdk/src/azure/iot/libaz_iot_provisioning.a
EXTRA_LIBS			+= $(NO-OS)/libraries/azure-sdk-for-c/build/sdk/src/azure/platform/libaz_noplatform.a
EXTRA_LIBS			+= $(NO-OS)/libraries/azure-sdk-for-c/build/sdk/src/azure/platform/libaz_nohttp.a
EXTRA_LIBS			+= $(NO-OS)/libraries/azure-sdk-for-c/build/sdk/src/azure/iot/libaz_iot_adu.a
EXTRA_LIBS			+= $(NO-OS)/libraries/azure-sdk-for-c/build/sdk/src/azure/iot/libaz_iot_common.a
EXTRA_LIBS			+= $(NO-OS)/libraries/azure-sdk-for-c/build/sdk/src/azure/core/libaz_core.a
