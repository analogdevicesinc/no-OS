...
#ifndef MAX78000_CAPI_COPROCESSOR_H_
#define MAX78000_CAPI_COPROCESSOR_H_
...
struct maxim_capi_coprocessor_config {
	...
	/**
	 * Configure P1.0-P1.3 for the RV32 JTAG port before CPU1 boots. This is
	 * intended for an attached OpenOCD/Olimex probe and defaults to false.
	 */
	bool enable_debug;
};
...
#endif /* MAX78000_CAPI_COPROCESSOR_H_ */
