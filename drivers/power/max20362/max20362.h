...
#define MAX20362_RRCFG1_RRCLKPOLARITY_MSK NO_OS_BIT(6)        /**< RR clock polarity */
#define MAX20362_RRCFG1_RRTIMEOUTRES_MSK  NO_OS_BIT(5)        /**< RR timeout reset */
...
struct max20362_dev {
	...
	enum max20362_dvs_source dvs_source;	/**< DVS source selection */
};
