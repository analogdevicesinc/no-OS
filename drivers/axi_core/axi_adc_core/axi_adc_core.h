...
#define AXI_ADC_IQCORRECTION_DISABLE	NO_OS_BIT(0)
#define AXI_ADC_DCFILTER_DISABLE	NO_OS_BIT(1)
#define AXI_ADC_DATAFORMAT_DISABLE	NO_OS_BIT(2)
#define AXI_ADC_USERPORTS_DISABLE	NO_OS_BIT(3)
#define AXI_ADC_MODE_1R1T		NO_OS_BIT(4)
#define AXI_ADC_DELAY_CONTROL_DISABLE 	NO_OS_BIT(5)
#define AXI_ADC_CMOS_OR_LVDS_N		NO_OS_BIT(7)
#define AXI_ADC_PPS_RECEIVER_ENABLE	NO_OS_BIT(8)
#define AXI_ADC_SCALECORRECTION_ONLY	NO_OS_BIT(9)
