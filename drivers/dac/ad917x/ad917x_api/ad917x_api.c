...
#define DLL_CLK_FREQ_THRES_HZ UINT64_C(4500000000)
#define DAC_9171_CLK_FREQ_MAX_HZ UINT64_C(6000000000)
#define DAC_CLK_FREQ_MAX_HZ UINT64_C(12000000000)
#define DAC_CLK_FREQ_MIN_HZ UINT64_C(2900000000)
