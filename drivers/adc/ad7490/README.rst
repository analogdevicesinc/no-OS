...
Other configurations such as range which can be either REFIN (2.5V) or double 
...
More to this, the type of sequencer can be changed without stoping the sequence
...
use te **ad7490_read_seq** API which handles all the required operations
