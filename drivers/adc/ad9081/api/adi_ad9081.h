...
#define AD9081_DAC_CLK_FREQ_HZ_MIN UINT64_C(2850000000)
#define AD9081_DAC_CLK_FREQ_HZ_MAX UINT64_C(12600000000)
#define AD9081_ADC_CLK_FREQ_HZ_MIN UINT64_C(1425000000)
#define AD9081_ADC_CLK_FREQ_HZ_MAX UINT64_C(4200000000)
#define AD9081_REF_CLK_FREQ_HZ_MIN UINT64_C(100000000)
#define AD9081_REF_CLK_FREQ_HZ_MAX UINT64_C(2000000000)

#define AD9082_ID 0x9082
#define AD9082_ADC_CLK_FREQ_HZ_MAX UINT64_C(6300000000)

#define AD9081_JESDRX_204C_CAL_THRESH UINT64_C(16000000000)
