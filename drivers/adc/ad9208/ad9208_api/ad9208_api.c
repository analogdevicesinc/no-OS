...
#define AD9208_IP_CLK_MIN_HZ UINT64_C(2500000000)
#define AD9208_IP_CLK_MAX_HZ UINT64_C(6000000000)
#define AD9208_ADC_CLK_MIN_HZ UINT64_C(2500000000)
#define AD9208_ADC_CLK_MAX_HZ UINT64_C(3100000000)
