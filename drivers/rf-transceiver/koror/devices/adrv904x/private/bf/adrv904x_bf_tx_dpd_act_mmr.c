/** 
 * \file adrv904x_bf_tx_dpd_act_mmr.c Automatically generated file with generator ver 0.0.16.0.
 * 
...
#define ADI_FILE ADI_ADRV904X_FILE_PRIVATE_BF_TX_DPD_ACT_MMR
                                                                           ...
                                                                           const uint8_t bfValue)
{
        ...
        (bfValue > 15U))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         bfValue,
                         "Invalid BitField Value in adrv904x_TxDpdActMmr_DpdDdrOutShift_BfSet");
        return recoveryAction;
    }
#endif /* ADRV904X_BITFIELD_VALUE_CHECK */

#if ADRV904X_BITFIELD_ADDR_CHECK > 0
    if ((baseAddr != ADRV904X_BF_SLICE_TX_0__TX_DFE_TX_DPD_ACT_MMR) &&
            (baseAddr != ADRV904X_BF_SLICE_TX_1__TX_DFE_TX_DPD_ACT_MMR) &&
            (baseAddr != ADRV904X_BF_SLICE_TX_2__TX_DFE_TX_DPD_ACT_MMR) &&
            (baseAddr != ADRV904X_BF_SLICE_TX_3__TX_DFE_TX_DPD_ACT_MMR) &&
            (baseAddr != ADRV904X_BF_SLICE_TX_4__TX_DFE_TX_DPD_ACT_MMR) &&
            (baseAddr != ADRV904X_BF_SLICE_TX_5__TX_DFE_TX_DPD_ACT_MMR) &&
            (baseAddr != ADRV904X_BF_SLICE_TX_6__TX_DFE_TX_DPD_ACT_MMR) &&
            (baseAddr != ADRV904X_BF_SLICE_TX_7__TX_DFE_TX_DPD_ACT_MMR))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ADI_ADRV904X_ERRSRC_DEVICEBF, 
                         ADI_COMMON_ERRCODE_INVALID_PARAM, 
                         ADI_ADRV904X_ERR_ACT_CHECK_PARAM,
                         baseAddr, 
                         "Invalid adrv904x_TxDpdActMmr_DpdDdrOutShift_BfSet Address");
        return recoveryAction;
    }
           ...
           )
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_ADRV904X_ERR_ACT_CHECK_PARAM,
                         channelId, 
                         "Invalid adrv904x_TxDpdActMmr_DpdDdrOutShift_BfSet Channel ID");
        return recoveryAction;
    }
    ...
    recoveryAction = adi_adrv904x_Register32Write(device,
                                                  spiCache,
                                                  ((uint32_t) baseAddr + 0x12 + channelId * 12U),
                                                  ((uint32_t) bfValue << 4),
                                                  0xF0U);
    ...
    *bfValue = (uint8_t) 0;
            ...
            (baseAddr != ADRV904X_BF_SLICE_TX_7__TX_DFE_TX_DPD_ACT_MMR))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_ADRV904X_ERR_ACT_CHECK_PARAM,
                         baseAddr, 
                         "Invalid adrv904x_TxDpdActMmr_DpdDdrOutShift_BfGet Address");
        return recoveryAction;
    }
#endif /* ADRV904X_BITFIELD_ADDR_CHECK */ 
           ...
           )
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_ADRV904X_ERR_ACT_CHECK_PARAM,
                         channelId, 
                         "Invalid adrv904x_TxDpdActMmr_DpdDdrOutShift_BfGet Channel ID");
        return recoveryAction;
    }
#endif /* ADRV904X_CHANNEL_ID_CHECK */
                                                                           ...
                                                                           const uint8_t bfValue)
{
        ...
        (bfValue > 15U))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_ADRV904X_ERR_ACT_CHECK_PARAM, 
                         bfValue,
                         "Invalid BitField Value in adrv904x_TxDpdActMmr_DpdGmpOutShift_BfSet");
        return recoveryAction;
    }
#endif /* ADRV904X_BITFIELD_VALUE_CHECK */
            ...
            (baseAddr != ADRV904X_BF_SLICE_TX_7__TX_DFE_TX_DPD_ACT_MMR))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_ADRV904X_ERR_ACT_CHECK_PARAM,
                         baseAddr, 
                         "Invalid adrv904x_TxDpdActMmr_DpdGmpOutShift_BfSet Address");
        return recoveryAction;
    }
#endif /* ADRV904X_BITFIELD_ADDR_CHECK */ 
           ...
           )
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_ADRV904X_ERR_ACT_CHECK_PARAM,
                         channelId, 
                         "Invalid adrv904x_TxDpdActMmr_DpdGmpOutShift_BfSet Channel ID");
        return recoveryAction;
    }
#endif /* ADRV904X_CHANNEL_ID_CHECK */
    ...
    *bfValue = (uint8_t) 0;
            ...
            (baseAddr != ADRV904X_BF_SLICE_TX_7__TX_DFE_TX_DPD_ACT_MMR))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_ADRV904X_ERR_ACT_CHECK_PARAM,
                         baseAddr, 
                         "Invalid adrv904x_TxDpdActMmr_DpdGmpOutShift_BfGet Address");
        return recoveryAction;
    }
#endif /* ADRV904X_BITFIELD_ADDR_CHECK */ 
           ...
           )
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_ADRV904X_ERR_ACT_CHECK_PARAM,
                         channelId, 
                         "Invalid adrv904x_TxDpdActMmr_DpdGmpOutShift_BfGet Channel ID");
        return recoveryAction;
    }
#endif /* ADRV904X_CHANNEL_ID_CHECK */
                                                                    ...
                                                                    const uint8_t bfValue)
{
        ...
        (bfValue > 255U))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_ADRV904X_ERR_ACT_CHECK_PARAM, 
                         bfValue,
                         "Invalid BitField Value in adrv904x_TxDpdActMmr_MagGain_BfSet");
        return recoveryAction;
    }
#endif /* ADRV904X_BITFIELD_VALUE_CHECK */
            ...
            (baseAddr != ADRV904X_BF_SLICE_TX_7__TX_DFE_TX_DPD_ACT_MMR))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_ADRV904X_ERR_ACT_CHECK_PARAM,
                         baseAddr, 
                         "Invalid adrv904x_TxDpdActMmr_MagGain_BfSet Address");
        return recoveryAction;
    }
#endif /* ADRV904X_BITFIELD_ADDR_CHECK */ 
           ...
           )
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_ADRV904X_ERR_ACT_CHECK_PARAM,
                         channelId, 
                         "Invalid adrv904x_TxDpdActMmr_MagGain_BfSet Channel ID");
        return recoveryAction;
    }
#endif /* ADRV904X_CHANNEL_ID_CHECK */
    ...
    recoveryAction = adi_adrv904x_Register32Write(device,
                                                  spiCache,
                                                  ((uint32_t) baseAddr + 0x10 + channelId * 12),
                                                  bfValue << 4,
                                                  0xF0);
    if (ADI_ADRV904X_ERR_ACT_NONE != recoveryAction)
    {
    ...
    recoveryAction = adi_adrv904x_Register32Write(device,
                                                  spiCache,
                                                  ((uint32_t) baseAddr + 0x11 + channelId * 12),
                                                  bfValue >> 4,
                                                  0xF);
    if (ADI_ADRV904X_ERR_ACT_NONE != recoveryAction)
    {
                                                                    ...
                                                                    uint8_t* const bfValue)
{
    ...
    *bfValue = (uint8_t) 0;
            ...
            (baseAddr != ADRV904X_BF_SLICE_TX_7__TX_DFE_TX_DPD_ACT_MMR))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_ADRV904X_ERR_ACT_CHECK_PARAM,
                         baseAddr, 
                         "Invalid adrv904x_TxDpdActMmr_MagGain_BfGet Address");
        return recoveryAction;
    }
#endif /* ADRV904X_BITFIELD_ADDR_CHECK */ 
           ...
           )
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_ADRV904X_ERR_ACT_CHECK_PARAM,
                         channelId, 
                         "Invalid adrv904x_TxDpdActMmr_MagGain_BfGet Channel ID");
        return recoveryAction;
    }
#endif /* ADRV904X_CHANNEL_ID_CHECK */
    ...
    recoveryAction = adi_adrv904x_Register32Read(device,
                                                 spiCache,
                                                 (uint32_t) (baseAddr + 0x10 + channelId * 12U),
                                                 &bfValueTmp,
                                                 0xF0U);
    if (ADI_ADRV904X_ERR_ACT_NONE != recoveryAction)
    {
    ...
    *bfValue = (uint8_t) ((uint64_t)(*bfValue) | (((uint64_t)bfValueTmp) >> 4));
    ...
    recoveryAction = adi_adrv904x_Register32Read(device,
                                                 spiCache,
                                                 (uint32_t) (baseAddr + 0x11 + channelId * 12U),
                                                 &bfValueTmp,
                                                 0xFU);
    if (ADI_ADRV904X_ERR_ACT_NONE != recoveryAction)
    {
