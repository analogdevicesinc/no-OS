/** 
 * \file adrv904x_bf_pll_mem_map.c Automatically generated file with generator ver 0.0.16.0.
 * 
...
#define ADI_FILE ADI_ADRV904X_FILE_PRIVATE_BF_PLL_MEM_MAP
                                                                       ...
                                                                       uint8_t* const bfValue)
{
    ...
    *bfValue = (uint8_t) 0;
    ...
    if ((baseAddr != ADRV904X_BF_DIGITAL_CORE_EAST_RFPLL) &&
            (baseAddr != ADRV904X_BF_DIGITAL_CORE_WEST_RFPLL) &&
            (baseAddr != ADRV904X_BF_DIGITAL_CORE_JESD_SERDES_PLL) &&
            (baseAddr != ADRV904X_BF_DIGITAL_CORE_JESD_CLKPLL))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         baseAddr, 
                         "Invalid adrv904x_PllMemMap_McsSpiStatus_BfGet Address");
    ...
    *bfValue = (uint8_t) 0;
            ...
            (baseAddr != ADRV904X_BF_DIGITAL_CORE_JESD_CLKPLL))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_ADRV904X_ERR_ACT_CHECK_PARAM,
                         baseAddr, 
                         "Invalid adrv904x_PllMemMap_SelRxLo_BfGet Address");
        return recoveryAction;
    }
#endif /* ADRV904X_BITFIELD_ADDR_CHECK */ 
    ...
    *bfValue = (uint8_t) 0;
            ...
            (baseAddr != ADRV904X_BF_DIGITAL_CORE_JESD_CLKPLL))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_ADRV904X_ERR_ACT_CHECK_PARAM,
                         baseAddr, 
                         "Invalid adrv904x_PllMemMap_SelTxLo_BfGet Address");
        return recoveryAction;
    }
#endif /* ADRV904X_BITFIELD_ADDR_CHECK */ 
    ...
    *bfValue = (uint8_t) 0;
            ...
            (baseAddr != ADRV904X_BF_DIGITAL_CORE_JESD_CLKPLL))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_ADRV904X_ERR_ACT_CHECK_PARAM,
                         baseAddr, 
                         "Invalid adrv904x_PllMemMap_SynLock_BfGet Address");
        return recoveryAction;
    }
#endif /* ADRV904X_BITFIELD_ADDR_CHECK */ 
