/** 
 * \file adrv904x_bf_serdes_rxdig_8pack_regmap_core1p2.c Automatically generated file with generator ver
 * 0.0.16.0.
 * 
...
#define ADI_FILE ADI_ADRV904X_FILE_PRIVATE_BF_SERDES_RXDIG_8PACK_REGMAP_CORE1P2

ADI_API adi_adrv904x_ErrAction_e adrv904x_SerdesRxdig8packRegmapCore1p2_RxdesPdCh_BfSet(adi_adrv904x_Device_t* const device,
                                                                                        adi_adrv904x_SpiCache_t* const spiCache,
                                                                                        const adrv904x_BfSerdesRxdig8packRegmapCore1p2ChanAddr_e baseAddr,
                                                                                        const uint8_t bfValue)
{
        ...
        (bfValue > 255U))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         bfValue,
                         "Invalid BitField Value in adrv904x_SerdesRxdig8packRegmapCore1p2_RxdesPdCh_BfSet");
        return recoveryAction;
    }
#endif /* ADRV904X_BITFIELD_VALUE_CHECK */

#if ADRV904X_BITFIELD_ADDR_CHECK > 0
    if ((baseAddr != ADRV904X_BF_DIGITAL_CORE_JESD_DESERIALIZER_DESER_PHY_TOP_8PACK))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ADI_ADRV904X_ERRSRC_DEVICEBF, 
                         ADI_COMMON_ERRCODE_INVALID_PARAM, 
                         ADI_ADRV904X_ERR_ACT_CHECK_PARAM,
                         baseAddr, 
                         "Invalid adrv904x_SerdesRxdig8packRegmapCore1p2_RxdesPdCh_BfSet Address");
        return recoveryAction;
    }
...
ADI_API adi_adrv904x_ErrAction_e adrv904x_SerdesRxdig8packRegmapCore1p2_RxdesPdCh_BfGet(adi_adrv904x_Device_t* const device,
                                                                                        adi_adrv904x_SpiCache_t* const spiCache,
                                                                                        const adrv904x_BfSerdesRxdig8packRegmapCore1p2ChanAddr_e baseAddr,
    ...
    *bfValue = (uint8_t) 0;
    ...
    if ((baseAddr != ADRV904X_BF_DIGITAL_CORE_JESD_DESERIALIZER_DESER_PHY_TOP_8PACK))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_ADRV904X_ERR_ACT_CHECK_PARAM,
                         baseAddr, 
                         "Invalid adrv904x_SerdesRxdig8packRegmapCore1p2_RxdesPdCh_BfGet Address");
        return recoveryAction;
    }
#endif /* ADRV904X_BITFIELD_ADDR_CHECK */ 
