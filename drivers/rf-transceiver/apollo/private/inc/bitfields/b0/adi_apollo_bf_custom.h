...
#include "adi_apollo_bf_interrupt_transmuter.h"
...
#define REG_RAM_BOOT_ERROR_PTR                              (0x21000424U)
...
#define BF_FW_IRQ_OUT_SOURCE_INFO                           REG_SCRATCH_REGS_ADDR(0x90), 0x00001800

#define REG_ADC_SLICE_MODE_SWITCH_ENABLE_ADDR               REG_SCRATCH_REGS_ADDR(0xBD)
#define REG_ADC_SLICE_MODE_SWITCH_CHANNEL_MASK_ADDR         REG_SCRATCH_REGS_ADDR(0xBC)
#define REG_ADC_SLICE_MODE_SWITCH_TRIGGER_ADDR              REG_TRIGGER_ADDR(14)

// NVM CAL Data Fuse Status Register and BitFields
#define REG_NVM_CALDATA_FUSED_ADDR                          REG_SCRATCH_REGS_ADDR(0xA2)
#define BF_ADC_NVM_CALDATA_FUSED_INFO                       REG_NVM_CALDATA_FUSED_ADDR, 0x00000100
#define BF_DAC_NVM_CALDATA_FUSED_INFO                       REG_NVM_CALDATA_FUSED_ADDR, 0x00000101
#define BF_SERDES_JRX_NVM_CALDATA_FUSED_INFO                REG_NVM_CALDATA_FUSED_ADDR, 0x00000102
#define BF_SERDES_JTX_NVM_CALDATA_FUSED_INFO                REG_NVM_CALDATA_FUSED_ADDR, 0x00000103
...
// Individual datapath control for LB1/LB2
