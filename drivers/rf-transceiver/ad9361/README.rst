...
An API is available for systems without an OS to interact with the AD9361,
providing all necessary control functions.

Below is a short description of all functions provided in the API:
...
Initializes the FMCOMMS2 board. Receives a structure containing the AD9361
initial parameters. Returns a structure containing the AD9361 current state
...
Sets the Enable State Machine (ENSM) mode. Parameters: structure with AD9361
current state, and the ENSM mode (SLEEP, ALERT, FDD, PINCTRL). Returns 0 on
...
Gets the Enable State Machine (ENSM) mode. Parameters: structure with AD9361
current state, and a variable to store the selected ENSM mode. Returns 0 on
success, negative error code otherwise.
...
Sets the receive RF gain for the selected channel. Parameters: structure with
AD9361 current state, desired channel number (0, 1), and the RF gain. Returns
...
Gets current receive RF gain for the selected channel. Parameters: structure
with AD9361 current state, desired channel (0, 1), and a variable to store the
RF gain. Returns 0 on success, negative error code otherwise.
...
Sets the RF bandwidth. Parameters: structure with AD9361 current state and
desired bandwidth in Hz. Returns 0 on success, negative error code otherwise.
...
Gets current RF bandwidth. Parameters: structure with AD9361 current state and
a variable to store the bandwidth value in Hz. Returns 0 on success, negative
...
Sets the sampling frequency. Parameters: structure with AD9361 current state
and desired sampling frequency in Hz. Returns 0 on success, negative error
code otherwise.
...
Gets current sampling frequency. Parameters: structure with AD9361 current
state and a variable to store the sampling frequency value in Hz. Returns 0 on
success, negative error code otherwise.
...
Sets the LO frequency. Parameters: structure with AD9361 current state and
desired LO frequency in Hz. Returns 0 on success, negative error code
otherwise.
...
Gets current LO frequency. Parameters: structure with AD9361 current state and
a variable to store the LO frequency value in Hz. Returns 0 on success,
...
Switches between internal and external LO. Parameters: structure with AD9361
current state and desired LO source (INT_LO or EXT_LO). Returns 0 on success,
negative error code otherwise.
...
Gets the RSSI for the selected channel. Parameters: structure with AD9361
current state, desired channel (0, 1), and a variable to store the RSSI.
...
Sets the gain control mode for the selected channel. Parameters: structure with
AD9361 current state, desired channel (0, 1), and gain control mode (GAIN_MGC,
GAIN_FASTATTACK_AGC, GAIN_SLOWATTACK_AGC, GAIN_HYBRID_AGC). Returns 0 on
success, negative error code otherwise.
...
Gets the gain control mode for the selected channel. Parameters: structure with
AD9361 current state, desired channel (0, 1), and a variable to store the gain
control mode. Returns 0 on success, negative error code otherwise.
...
Sets the FIR filter configuration. Parameters: structure with AD9361 current
state and the FIR filter configuration. Returns 0 on success, negative error
code otherwise.
...
Gets the FIR filter configuration. Parameters: structure with AD9361 current
state and a variable to store the FIR filter configuration. Returns 0 on
success, negative error code otherwise.
...
Enables/disables the FIR filter. Parameters: structure with AD9361 current
state and the option (ENABLE, DISABLE). Returns 0 on success, negative error
code otherwise.
...
Gets the status of the FIR filter. Parameters: structure with AD9361 current
state and the enable/disable status buffer. Returns 0 on success, negative
error code otherwise.
...
Enables/disables the RX RFDC Tracking. Parameters: structure with AD9361
current state and the option (ENABLE, DISABLE). Returns 0 on success, negative
error code otherwise.
...
Gets the status of the RX RFDC Tracking. Parameters: structure with AD9361
current state and the enable/disable status buffer. Returns 0 on success,
negative error code otherwise.
...
Enables/disables the RX BasebandDC Tracking. Parameters: structure with AD9361
current state and the option (ENABLE, DISABLE). Returns 0 on success, negative
error code otherwise.
...
Gets the status of the RX BasebandDC Tracking. Parameters: structure with
AD9361 current state and the enable/disable status buffer. Returns 0 on
success, negative error code otherwise.
...
Enables/disables the RX Quadrature Tracking. Parameters: structure with AD9361
current state and the option (ENABLE, DISABLE). Returns 0 on success, negative
error code otherwise.
...
Gets the status of the RX Quadrature Tracking. Parameters: structure with
AD9361 current state and the enable/disable status buffer. Returns 0 on
success, negative error code otherwise.
...
Sets the RX RF input port. Parameters: structure with AD9361 current state and
desired RF input port (A_BALANCED, B_BALANCED, C_BALANCED, A_N, A_P, B_N, B_P,
C_N, C_P, TX_MON1, TX_MON2 or TX_MON1_2). Returns 0 on success, negative
error code otherwise.
...
Gets the RX RF input port. Parameters: structure with AD9361 current state and
a variable to store the RF input port. Returns 0 on success, negative error
code otherwise.
...
(ad9361_set_rx_lo_freq()) then call this function specifying the target profile
number. Parameters: structure with AD9361 current state and the profile number
(0 - 7). Returns 0 on success, negative error code otherwise.
...
(init_param->rx_fastlock_pincontrol_enable), the function needs to be called
before the pin-control can be used. Parameters: structure with AD9361 current
state and profile number (0 - 7). Returns 0 on success, negative error code
otherwise.
...
Loads RX fastlock profile. A previously saved profile can be loaded in any of
the 8 available slots. Parameters: structure with AD9361 current state, profile
number (0 - 7), and the fastlock profile program data. Returns 0 on success,
negative error code otherwise.
...
Saves RX fastlock profile. To use more than 8 profiles, an existing profile can
be read back and stored by the user application. Parameters: structure with
AD9361 current state, profile number (0 - 7), and the fastlock profile program
data. Returns 0 on success, negative error code otherwise.
...
Powers down the RX Local Oscillator. Parameters: structure with AD9361 current
state and the power down option (ON, OFF). Returns 0 on success, negative
error code otherwise.
...
Gets the RX Local Oscillator power status. Parameters: structure with AD9361
current state and a variable to store the power status. Returns 0 on success,
negative error code otherwise.
...
Sets the transmit attenuation for the selected channel. Parameters: structure
with AD9361 current state, desired channel number (0, 1), and the attenuation
in dB. Returns 0 on success, negative error code otherwise.
...
Gets current transmit attenuation for the selected channel. Parameters:
structure with AD9361 current state, desired channel (0, 1), and a variable to
store the attenuation value in dB. Returns 0 on success, negative error code
otherwise.
...
Gets the TX RSSI for the selected channel. Parameters: structure with AD9361
current state, desired channel (0, 1), and a variable to store the RSSI.
Returns 0 on success, negative error code otherwise.
...
Sets the TX RF output port. Parameters: structure with AD9361 current state and
desired RF output port (TXA or TXB). Returns 0 on success, negative error code
otherwise.
...
Gets the TX RF output port. Parameters: structure with AD9361 current state and
a variable to store the RF output port. Returns 0 on success, negative error
code otherwise.
...
Enables/disables the auto calibration. Parameters: structure with AD9361
current state and the option (ENABLE, DISABLE). Returns 0 on success, negative
error code otherwise.
...
Gets the status of the auto calibration flag. Parameters: structure with AD9361
current state and a variable to store the option. Returns 0 on success,
negative error code otherwise.
...
(ad9361_set_tx_lo_freq()) then call this function specifying the target profile
number. Parameters: structure with AD9361 current state and profile number
(0 - 7). Returns 0 on success, negative error code otherwise.
...
(init_param->tx_fastlock_pincontrol_enable), the function needs to be called
before the pin-control can be used. Parameters: structure with AD9361 current
state and profile number (0 - 7). Returns 0 on success, negative error code
otherwise.
...
Loads TX fastlock profile. A previously saved profile can be loaded in any of
the 8 available slots. Parameters: structure with AD9361 current state, profile
number (0 - 7), and the fastlock profile program data. Returns 0 on success,
negative error code otherwise.
...
Saves TX fastlock profile. To use more than 8 profiles, an existing profile can
be read back and stored by the user application. Parameters: structure with
AD9361 current state, profile number (0 - 7), and the fastlock profile program
data. Returns 0 on success, negative error code otherwise.
...
Powers down the TX Local Oscillator. Parameters: structure with AD9361 current
state and the power down option (ON, OFF). Returns 0 on success, negative
error code otherwise.
...
Gets the TX Local Oscillator power status. Parameters: structure with AD9361
current state and a variable to store the power status. Returns 0 on success,
negative error code otherwise.
...
Sets the RX and TX path rates. Parameters: structure with AD9361 current state,
the RX and the TX clocks. Returns 0 on success, negative error code otherwise.
...
Gets the RX and TX path rates. Parameters: structure with AD9361 current state,
the RX and the TX buffers to store the clock frequencies. Returns 0 on success,
negative error code otherwise.
...
Set the number of channels mode. Parameters: structure with AD9361 current
state and number of channels mode (1 - 1x1; 2 - 2x2). Returns 0 on success,
negative error code otherwise.
...
Does multi chip synchronization. Parameters: structure with Master AD9361
current state and structure with Slave AD9361 current state. Returns 0 on
success, negative error code otherwise.
...
Enables/disables the TRX FIR filters. Parameters: structure with AD9361
current state and the option (ENABLE or DISABLE). Returns 0 on success,
negative error code otherwise.
...
Sets the OSR rate governor. Parameters: structure with AD9361 current state and
the OSR rate governor (HIGHEST_OSR or NOMINAL_OSR). Returns 0 on success,
negative error code otherwise.
...
Gets the OSR rate governor. Parameters: structure with AD9361 current state and
a variable to store the OSR rate governor. Returns 0 on success, negative error
code otherwise.
...
Performs the selected calibration. Parameters: structure with AD9361 current
state, desired calibration (TX_QUAD_CAL, RFDC_CAL), and for TX_QUAD_CAL the
optional RX phase value overwrite (set to zero). Returns 0 on success, negative
error code otherwise.
...
Loads and enables TRX FIR filters configurations. Parameters: structure with
AD9361 current state, RX FIR filter configuration, and TX FIR filter
configuration. Returns 0 on success, negative error code otherwise.
...
Does DCXO coarse tuning. Parameters: structure with AD9361 current state and
the DCXO coarse tuning value. Returns 0 on success, negative error code
otherwise.
...
Does DCXO fine tuning. Parameters: structure with AD9361 current state and the
DCXO fine tuning value. Returns 0 on success, negative error code otherwise.
...
Gets the temperature. Parameters: structure with AD9361 current state and a
variable to store the temperature (degrees C x 1000). Returns 0 on success,
negative error code otherwise.

Notes
-----

Note 1: AD9361_InitParam Structure
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

Used by the ad9361_init() function. For more details on each member, see
AD9361 Device Driver Customization page.
...
Note 2: rf_rssi Structure
^^^^^^^^^^^^^^^^^^^^^^^^^

Used by the ad9361_get_rx_rssi() function:
...
Note 3: AD9361_RXFIRConfig Structure
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

Used by the ad9361_set_rx_fir_config() function:
...
Note 4: AD9361_TXFIRConfig Structure
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

Used by the ad9361_set_tx_fir_config() function:
