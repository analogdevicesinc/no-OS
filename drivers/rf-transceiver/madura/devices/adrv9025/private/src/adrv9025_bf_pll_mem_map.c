                                           ...
                                           uint8_t*                       bfValue)
{
    ...
    if ((baseAddr != ADRV9025_BF_ALL_PLLS) &&
        (baseAddr != ADRV9025_BF_AUX_PLL) &&
        (baseAddr != ADRV9025_BF_CLK_PLL) &&
        (baseAddr != ADRV9025_BF_RF1_PLL) &&
        (baseAddr != ADRV9025_BF_RF2_PLL))
    {
        ADI_ERROR_REPORT(&device->common,
                         ...
                         baseAddr,
                         "Invalid adrv9025_PllMemMapAuxAdcReadyBfGet Address");
                                          ...
                                          uint8_t*                       bfValue)
{
        ...
        (baseAddr != ADRV9025_BF_RF2_PLL))
    {
        ADI_ERROR_REPORT(&device->common,
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr,
                         "Invalid adrv9025_PllMemMapRx12SelLo2BfGet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif
    adrv9025_BfReadCacheInit(device);
                                          ...
                                          uint8_t*                       bfValue)
{
        ...
        (baseAddr != ADRV9025_BF_RF2_PLL))
    {
        ADI_ERROR_REPORT(&device->common,
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr,
                         "Invalid adrv9025_PllMemMapRx34SelLo2BfGet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif
    adrv9025_BfReadCacheInit(device);
                                       ...
                                       uint8_t*                       bfValue)
{
        ...
        (baseAddr != ADRV9025_BF_RF2_PLL))
    {
        ADI_ERROR_REPORT(&device->common,
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr,
                         "Invalid adrv9025_PllMemMapSynLockBfGet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif
    adrv9025_BfReadCacheInit(device);
                                          ...
                                          uint8_t*                       bfValue)
{
        ...
        (baseAddr != ADRV9025_BF_RF2_PLL))
    {
        ADI_ERROR_REPORT(&device->common,
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr,
                         "Invalid adrv9025_PllMemMapTx12SelLo2BfGet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif
    adrv9025_BfReadCacheInit(device);
                                          ...
                                          uint8_t*                       bfValue)
{
        ...
        (baseAddr != ADRV9025_BF_RF2_PLL))
    {
        ADI_ERROR_REPORT(&device->common,
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr,
                         "Invalid adrv9025_PllMemMapTx34SelLo2BfGet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif
    adrv9025_BfReadCacheInit(device);
