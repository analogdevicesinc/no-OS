...
+=====================+==============================+===============================+===============================+
| VCOPK Enable        | Enables VCO peak function    | ``HMC630X_EN_VCOPK``          | Enhances VCO performance      |
|                     |                              |                               | in RF systems.                |
+---------------------+------------------------------+-------------------------------+-------------------------------+
| CPCMFB Enable       | Enables common-mode feedback | ``HMC630X_EN_CPCMFB``         | Stabilizes signals in         |
|                     |                              |                               | modulation processes.         |
+---------------------+------------------------------+-------------------------------+-------------------------------+
| Down State          | Device down state            | ``HMC630X_DN``                | Power saving mode during      |
|                     |                              |                               | idleness.                     |
+---------------------+------------------------------+-------------------------------+-------------------------------+
| Feedback Divider    | Feedback divider CML2CMOS    | ``HMC630X_EN_FBDIV_CML2CMOS`` | Adapts systems for            |
| CML2CMOS            | conversion                   |                               | mixed-signal environments.    |
+---------------------+------------------------------+-------------------------------+-------------------------------+
| Enable Amplifier    | Activates PA, attenuation    | ``HMC6300_EN_TEMPFLASH``,     | Manages power in transmission |
|                     |                              | ``HMC6300_PA_PWRDWN_FAST``    | systems.                      |
+---------------------+------------------------------+-------------------------------+-------------------------------+
| Baseband Low-Pass   | Sets BB LPF corner           | Enumerated with               | Adjusts baseband processing   |
|                     |                              | ``hmc6301_bb_lpc``            | characteristics.              |
+---------------------+------------------------------+-------------------------------+-------------------------------+
| Baseband High-Pass  | Sets BB HPF corner           | Enumerated with               | Eliminates unwanted           |
|                     |                              | ``hmc6301_bb_hpc``            | low-frequency signals.        |
+---------------------+------------------------------+-------------------------------+-------------------------------+
| PA Power Down       | Fast PA shutdown             | ``HMC6300_PA_PWRDWN_FAST``    | Manages power during          |
