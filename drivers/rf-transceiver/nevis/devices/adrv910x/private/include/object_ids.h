...
typedef enum
{
    ...
    */
    ...
    OBJID_IC_TX_EXTLO            = GENERATE_OBJID(OBJ_GROUP_ID_IC, 0x3u),   /*!< 0x23: Object ID for TX ext LO Correction initcal */
    ...
    OBJID_IC_RX_EXTLO            = GENERATE_OBJID(OBJ_GROUP_ID_IC, 0xCu),   /*!< 0x2C: Object ID for RX ext LO correction Init Cal */
    ...
    */
    ...
    OBJID_GO_RX_RFDC_READ              = GENERATE_OBJID(OBJ_GROUP_ID_GO, 0x10u),   /*!< 0x70 Object ID for getting RFDC residual */
    OBJID_GO_SYNCDETECT_DATA_GET       = GENERATE_OBJID(OBJ_GROUP_ID_GO, 0x11u),   /*!< 0x71 Object ID for getting Sync detection data */
    OBJID_GO_SYNCDETECT_DATA_READ_DONE = GENERATE_OBJID(OBJ_GROUP_ID_GO, 0x12u),   /*!< 0x72 Object ID for notifying Sync detection data read is finished by API */
	...
	// TODO: Temporarily disabled as it is unused to accommodate new GS mailbox command
    //OBJID_GS_ORX_TX_CTRL               = GENERATE_OBJID(OBJ_GROUP_ID_GS, 0x1u),     /*!< 0x81: Object ID for ORX TX select */
	OBJID_GS_CONTINUOUS_SYNC_DETECTION = GENERATE_OBJID(OBJ_GROUP_ID_GS, 0x1u),     /*!< 0x81: Object ID for continuous sync detection enablement */
    ...
    OBJID_GS_EXTLO_VCO_PARAMS         = GENERATE_OBJID(OBJ_GROUP_ID_GS, 0x1Eu),    /*!< 0x9e: Set ID for Changing ExtLo VCO Parameters */
    OBJID_GS_LO_OFFSET_CONFIGURE      = GENERATE_OBJID(OBJ_GROUP_ID_GS, 0x1Fu),    /*!< 0x9f: Set ID for Changing RXNB LO and LO offset in primed state */
    ...
    */
    ...
    OBJID_CFG_HIGH_BLOCKER_CONFIG     = GENERATE_OBJID(OBJ_GROUP_ID_CFG, 0x19u),   /*!< 0xB9: Start Reference Timer */
