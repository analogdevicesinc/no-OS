/*!
 * \brief     RECONFIG local defines and prototypes
 *
 ...
 * @{
 */
#ifndef __ADI_APOLLO_RECONFIG_LOCAL_H__
#define __ADI_APOLLO_RECONFIG_LOCAL_H__
...
#endif /* __ADI_APOLLO_RECONFIG_LOCAL_H__ */
/*! @} */
