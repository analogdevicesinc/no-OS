...
#ifdef USE_PRIVATE_BF
#define REG_SYSREF_DELAY_REG_EN_JRX_WRAPPER_ADDR(inst, n)      ((inst) + 0x00000067 + 1 * (n))
#define BF_SYSREF_PULSE_DELAY_ENABLE_JRX_WRAPPER_INFO(inst, n) ((inst) + 0x00000067 + 1 * (n)), 0x00000100
#endif /* USE_PRIVATE_BF */

#ifdef USE_PRIVATE_BF
#define REG_SYSREF_DELAY_REG_JRX_WRAPPER_ADDR(inst, n)         ((inst) + 0x00000069 + 1 * (n))
#define BF_SYSREF_PULSE_DELAY_CYCLES_JRX_WRAPPER_INFO(inst, n) ((inst) + 0x00000069 + 1 * (n)), 0x00000800
#endif /* USE_PRIVATE_BF */

#define REG_ATHENA_M_ADDR(inst, n)                             ((inst) + 0x0000006B + 1 * (n))
#define BF_JRX_MPARAM_RMFIFO_INFO(inst, n)                     ((inst) + 0x0000006B + 1 * (n)), 0x00000400

#define REG_ATHENA_NS_ADDR(inst, n)                            ((inst) + 0x0000006D + 1 * (n))
#define BF_JRX_NS_RMFIFO_INFO(inst, n)                         ((inst) + 0x0000006D + 1 * (n)), 0x00000500

#define REG_ATHENA_CTRL_ADDR(inst)                             ((inst) + 0x00000070)
#define BF_ATHENA_ENABLE_INFO(inst)                            ((inst) + 0x00000070), 0x00000100

#define REG_RB_M_PARAM_ADDR(inst, n)                           ((inst) + 0x00000071 + 1 * (n))
#define BF_READBACK_JRX_M_PARAM_INFO(inst, n)                  ((inst) + 0x00000071 + 1 * (n)), 0x00000400

#define REG_RB_L_PARAM_ADDR(inst, n)                           ((inst) + 0x00000073 + 1 * (n))
#define BF_READBACK_JRX_L_PARAM_INFO(inst, n)                  ((inst) + 0x00000073 + 1 * (n)), 0x00000500

#define REG_RB_E_PARAM_ADDR(inst, n)                           ((inst) + 0x00000075 + 1 * (n))
#define BF_READBACK_JRX_E_PARAM_INFO(inst, n)                  ((inst) + 0x00000075 + 1 * (n)), 0x00000500

#define REG_RB_S_PARAM_ADDR(inst, n)                           ((inst) + 0x00000077 + 1 * (n))
#define BF_READBACK_JRX_S_PARAM_INFO(inst, n)                  ((inst) + 0x00000077 + 1 * (n)), 0x00000400

#define REG_RB_F_PARAM_ADDR(inst, n)                           ((inst) + 0x00000079 + 1 * (n))
#define BF_READBACK_JRX_F_PARAM_INFO(inst, n)                  ((inst) + 0x00000079 + 1 * (n)), 0x00000500

#define REG_RB_K_PARAM_ADDR(inst, n)                           ((inst) + 0x0000007B + 1 * (n))
#define BF_READBACK_JRX_K_PARAM_INFO(inst, n)                  ((inst) + 0x0000007B + 1 * (n)), 0x00000800

#define REG_RB_N_PARAM_ADDR(inst, n)                           ((inst) + 0x0000007D + 1 * (n))
#define BF_READBACK_JRX_N_PARAM_INFO(inst, n)                  ((inst) + 0x0000007D + 1 * (n)), 0x00000400

#define REG_RB_NP_PARAM_ADDR(inst, n)                          ((inst) + 0x0000007F + 1 * (n))
#define BF_READBACK_JRX_NP_PARAM_INFO(inst, n)                 ((inst) + 0x0000007F + 1 * (n)), 0x00000400

#define REG_RB_NS_PARAM_ADDR(inst, n)                          ((inst) + 0x00000081 + 1 * (n))
#define BF_READBACK_JRX_NS_PARAM_INFO(inst, n)                 ((inst) + 0x00000081 + 1 * (n)), 0x00000500
