...
#define REG_TMODE_USR_LSB_P0_ADDR(inst, n)            ((inst) + 0x0000001D + 1 * (n))
#define BF_TMODE_USR_PAT0_INFO(inst, n)               ((inst) + 0x0000001D + 1 * (n)), 0x00001000

#define REG_TMODE_USR_MSB_P0_ADDR(inst, n)            ((inst) + 0x0000001F + 1 * (n))

#define REG_TMODE_USR_LSB_P1_ADDR(inst, n)            ((inst) + 0x00000021 + 1 * (n))
#define BF_TMODE_USR_PAT1_INFO(inst, n)               ((inst) + 0x00000021 + 1 * (n)), 0x00001000

#define REG_TMODE_USR_MSB_P1_ADDR(inst, n)            ((inst) + 0x00000023 + 1 * (n))

#define REG_TMODE_USR_LSB_P2_ADDR(inst, n)            ((inst) + 0x00000025 + 1 * (n))
#define BF_TMODE_USR_PAT2_INFO(inst, n)               ((inst) + 0x00000025 + 1 * (n)), 0x00001000

#define REG_TMODE_USR_MSB_P2_ADDR(inst, n)            ((inst) + 0x00000027 + 1 * (n))

#define REG_TMODE_USR_LSB_P3_ADDR(inst, n)            ((inst) + 0x00000029 + 1 * (n))
#define BF_TMODE_USR_PAT3_INFO(inst, n)               ((inst) + 0x00000029 + 1 * (n)), 0x00001000

#define REG_TMODE_USR_MSB_P3_ADDR(inst, n)            ((inst) + 0x0000002B + 1 * (n))

#define REG_TMODE_USR_LSB_P4_ADDR(inst, n)            ((inst) + 0x0000002D + 1 * (n))
#define BF_TMODE_USR_PAT4_INFO(inst, n)               ((inst) + 0x0000002D + 1 * (n)), 0x00001000

#define REG_TMODE_USR_MSB_P4_ADDR(inst, n)            ((inst) + 0x0000002F + 1 * (n))

#define REG_TMODE_USR_LSB_P5_ADDR(inst, n)            ((inst) + 0x00000031 + 1 * (n))
#define BF_TMODE_USR_PAT5_INFO(inst, n)               ((inst) + 0x00000031 + 1 * (n)), 0x00001000

#define REG_TMODE_USR_MSB_P5_ADDR(inst, n)            ((inst) + 0x00000033 + 1 * (n))

#define REG_TMODE_USR_LSB_P6_ADDR(inst, n)            ((inst) + 0x00000035 + 1 * (n))
#define BF_TMODE_USR_PAT6_INFO(inst, n)               ((inst) + 0x00000035 + 1 * (n)), 0x00001000

#define REG_TMODE_USR_MSB_P6_ADDR(inst, n)            ((inst) + 0x00000037 + 1 * (n))

#define REG_TMODE_USR_LSB_P7_ADDR(inst, n)            ((inst) + 0x00000039 + 1 * (n))
#define BF_TMODE_USR_PAT7_INFO(inst, n)               ((inst) + 0x00000039 + 1 * (n)), 0x00001000

#define REG_TMODE_USR_MSB_P7_ADDR(inst, n)            ((inst) + 0x0000004B + 1 * (n))
