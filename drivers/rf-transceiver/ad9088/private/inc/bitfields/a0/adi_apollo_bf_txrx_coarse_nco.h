...
/*============= D E F I N E S ==============*/
#define RX_COARSE_NCO0_RX_SLICE_0_RX_DIGITAL0                         0x60376000
#define RX_COARSE_NCO1_RX_SLICE_0_RX_DIGITAL0                         0x60377000
#define RX_COARSE_NCO0_RX_SLICE_1_RX_DIGITAL0                         0x60576000
#define RX_COARSE_NCO1_RX_SLICE_1_RX_DIGITAL0                         0x60577000
#define RX_COARSE_NCO0_RX_SLICE_0_RX_DIGITAL1                         0x60B76000
#define RX_COARSE_NCO1_RX_SLICE_0_RX_DIGITAL1                         0x60B77000
#define RX_COARSE_NCO0_RX_SLICE_1_RX_DIGITAL1                         0x60D76000
#define RX_COARSE_NCO1_RX_SLICE_1_RX_DIGITAL1                         0x60D77000
...
#define REG_CNCO_PSW0_ADDR(inst)                                      ((inst) + 0x00000000)
#define BF_DRC_PSW_INFO(inst)                                         ((inst) + 0x00000000), 0x00003000

#define REG_CNCO_PSW1_ADDR(inst)                                      ((inst) + 0x00000001)

#define REG_CNCO_PSW2_ADDR(inst)                                      ((inst) + 0x00000002)

#define REG_CNCO_PSW3_ADDR(inst)                                      ((inst) + 0x00000003)

#define REG_CNCO_PSW4_ADDR(inst)                                      ((inst) + 0x00000004)

#define REG_CNCO_PSW5_ADDR(inst)                                      ((inst) + 0x00000005)
...
#define BF_TRIG_HOP_PROFILE_CHANGE_INFO(inst)                         ((inst) + 0x00000010), 0x00000104
...
#define REG_PST_LOAD_CTRL_ADDR(inst)                                  ((inst) + 0x0000001E)
#define BF_PST_LOAD_ENABLE_INFO(inst)                                 ((inst) + 0x0000001E), 0x00000100

#define REG_PST_LOAD_VALUE0_ADDR(inst)                                ((inst) + 0x0000001F)
#define BF_PST_LOAD_VALUE_INFO(inst)                                  ((inst) + 0x0000001F), 0x00003000

#define REG_PST_LOAD_VALUE1_ADDR(inst)                                ((inst) + 0x00000020)

#define REG_PST_LOAD_VALUE2_ADDR(inst)                                ((inst) + 0x00000021)

#define REG_PST_LOAD_VALUE3_ADDR(inst)                                ((inst) + 0x00000022)

#define REG_PST_LOAD_VALUE4_ADDR(inst)                                ((inst) + 0x00000023)

#define REG_PST_LOAD_VALUE5_ADDR(inst)                                ((inst) + 0x00000024)

#define REG_PST_LOAD_STATUS_ADDR(inst)                                ((inst) + 0x00000025)
#define BF_PST_LOAD_STATUS_INFO(inst)                                 ((inst) + 0x00000025), 0x00000100
...
#endif /* USE_PRIVATE_BF */
#define BF_DEBUG_CDRC_CLKOFF_N_INFO(inst)                             ((inst) + 0x00000035), 0x00000102

#define REG_TRIG_HOP_ACTIVE_PROFILE_ADDR(inst)                        ((inst) + 0x00000036)
#define BF_TRIG_HOP_ACTIVE_PROFILE_INFO(inst)                         ((inst) + 0x00000036), 0x00000400
...
#define REG_DRC_PHASE_INC_FRAC_A3_TXRX_COARSE_NCO_ADDR(inst)          ((inst) + 0x00000048)
...
#define REG_DRC_PHASE_INC_FRAC_B3_TXRX_COARSE_NCO_ADDR(inst)          ((inst) + 0x0000004C)
