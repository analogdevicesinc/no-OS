...
#define BF_JTX_LANE_PD_INFO(inst, n)                        ((inst) + 0x00000020 + 1 * (n)), 0x00000107
...
#define BF_JTX_CONV_SEL_INFO(inst, n)                       ((inst) + 0x00000040 + 1 * (n)), 0x00000700
...
#define BF_JTX_E_CFG_INFO(inst)                             ((inst) + 0x000000F1), 0x00000800
