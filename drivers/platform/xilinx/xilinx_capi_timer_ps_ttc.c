                                  ...
                                  const struct capi_timer_config *config)
{
	...
	xh->handle.ops = config->ops ? config->ops : &capi_timer_xilinx_ps_ttc_ops;
...
static int capi_timer_ps_ttc_start(struct capi_timer_handle *handle)
{
	...
	XTtcPs_Start(inst((struct capi_timer_xilinx_handle *)handle));
...
static int capi_timer_ps_ttc_stop(struct capi_timer_handle *handle)
{
	...
	XTtcPs_Stop(inst((struct capi_timer_xilinx_handle *)handle));
