...
.. code-block:: C
        ...
        int iio_example(void)
        {
                ...
                adalm_lsmspg_devices[0].name = "ad5592r";
                adalm_lsmspg_devices[0].dev = iio_ad5592r;
                adalm_lsmspg_devices[0].dev_descriptor = &iio_ad5592r->iiodev;
                adalm_lsmspg_devices[0].read_buff = &ad5592r_read_data_buffer;
                adalm_lsmspg_devices[1].name = "ad5593r";
                adalm_lsmspg_devices[1].dev = iio_ad5593r;
                adalm_lsmspg_devices[1].dev_descriptor = &iio_ad5593r->iiodev;
                adalm_lsmspg_devices[1].read_buff = &ad5593r_read_data_buffer;

                iio_app_ip.devices = adalm_lsmspg_devices;
                iio_app_ip.nb_devices = 2;
