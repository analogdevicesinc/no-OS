...
static void apply_z(uECC_word_t * X1,
                    ...
                    uECC_Curve curve) {
    uECC_word_t t1[uECC_MAX_WORDS] = {0};
...
static void XYcZ_addC(uECC_word_t * X1,
    ...
    /* t1 = X1, t2 = Y1, t3 = X2, t4 = Y2 */
    uECC_word_t t5[uECC_MAX_WORDS] = {0};
    uECC_word_t t6[uECC_MAX_WORDS] = {0};
    uECC_word_t t7[uECC_MAX_WORDS] = {0};
    wordcount_t num_words = curve->num_words;
...
static void EccPoint_mult(uECC_word_t * result,
                          ...
                          uECC_Curve curve) {
    /* R0 and R1 */
    uECC_word_t Rx[2][uECC_MAX_WORDS] = {0};
    uECC_word_t Ry[2][uECC_MAX_WORDS] = {0};
    uECC_word_t z[uECC_MAX_WORDS] = {0};
    bitcount_t i;
    uECC_word_t nb;
    wordcount_t num_words = curve->num_words;
...
int uECC_valid_point(const uECC_word_t *point, uECC_Curve curve) {
    uECC_word_t tmp1[uECC_MAX_WORDS] = {0};
    uECC_word_t tmp2[uECC_MAX_WORDS] = {0};
    wordcount_t num_words = curve->num_words;
...
/* V = HMAC_K(V) */
void update_V(const uECC_HashContext *hash_context, uint8_t *K, uint8_t *V) {
...
int uECC_verify(const uint8_t *public_key,
                ...
                uECC_Curve curve) {
    uECC_word_t u1[uECC_MAX_WORDS] = {0};
    uECC_word_t u2[uECC_MAX_WORDS] = {0};
    uECC_word_t z[uECC_MAX_WORDS]  = {0};
