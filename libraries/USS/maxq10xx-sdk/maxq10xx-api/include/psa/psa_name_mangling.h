...
/**
 * @brief       This file contains the name mangling macros for the PSA Crypto API.
 *              This avoids duplication of symbols between TF-M and USS Crypto.
 * 
 */
...
#ifndef PSA_NAME_MANGLING_H
#define PSA_NAME_MANGLING_H

#define PSA_FUNCTION_NAME(x) uss_ ## x

#define psa_crypto_init                         PSA_FUNCTION_NAME(psa_crypto_init)

#define psa_key_attributes_init                 PSA_FUNCTION_NAME(psa_key_attributes_init)
...
#define psa_set_key_type                        PSA_FUNCTION_NAME(psa_set_key_type)
#define psa_get_key_type                        PSA_FUNCTION_NAME(psa_get_key_type)
#define psa_set_key_bits                        PSA_FUNCTION_NAME(psa_set_key_bits)
#define psa_get_key_bits                        PSA_FUNCTION_NAME(psa_get_key_bits)
#define psa_set_key_lifetime                    PSA_FUNCTION_NAME(psa_set_key_lifetime)
#define psa_get_key_lifetime                    PSA_FUNCTION_NAME(psa_get_key_lifetime)
#define psa_set_key_id                          PSA_FUNCTION_NAME(psa_set_key_id)
#define psa_get_key_id                          PSA_FUNCTION_NAME(psa_get_key_id)
#define psa_set_key_algorithm                   PSA_FUNCTION_NAME(psa_set_key_algorithm)
#define psa_get_key_algorithm                   PSA_FUNCTION_NAME(psa_get_key_algorithm)
#define psa_set_key_usage_flags                 PSA_FUNCTION_NAME(psa_set_key_usage_flags)
#define psa_get_key_usage_flags                 PSA_FUNCTION_NAME(psa_get_key_usage_flags)
...
#define psa_hash_suspend                        PSA_FUNCTION_NAME(psa_hash_suspend)
#define psa_hash_resume                         PSA_FUNCTION_NAME(psa_hash_resume)
...
#define psa_aead_operation_init                 PSA_FUNCTION_NAME(psa_aead_operation_init)
...
#define psa_key_derivation_operation_init       PSA_FUNCTION_NAME(psa_key_derivation_operation_init)
