...
#
#   1. Override: NO_OS_DEP_<LIB>_PATH (CMake var or env) is used verbatim, no checks.
...
function(resolve_library_source LIB_NAME REQUESTED_VERSION IN_TREE_PATH GIT_REPO_URL OUT_SOURCE_DIR OUT_BINARY_DIR)
    ...
    # --- Tier 1: NO_OS_DEP_<LIB>_PATH override, used as-is ---
    string(TOUPPER "${LIB_NAME}" _lib_upper)
    set(_override_var "NO_OS_DEP_${_lib_upper}_PATH")
    set(_override_dir "")
