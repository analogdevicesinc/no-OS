...
incorporates the :adi:`AD9144`, a Quad, 16-Bit, 2800 MSPS Digital-to-Analog
...
(DMA). The receive path includes the :adi:`AD9680`, a 14-Bit, 1000 MSPS Dual
...
:git-no-OS:`Project Common Data Path </projects/fmcdaq2/src/app>`.
