...
- ``capi/platform/maxim/max78000/maxim_capi_coprocessor.c`` -- CPU1 lifecycle
- ``capi/platform/maxim/max78000/maxim_ipc.{c,h}`` -- SEMA doorbell/mailbox
  IPC
- ``capi/platform/maxim/max78000/maxim_ipc_shared.h`` -- Shared table layout
