...
board designed to assess the :adi:`AD74413R` device. This board supports
...
communication. The EVAL-AD74413R requires an AVDD operating supply
...
operation. The EVAL-AD74413R requires an AVDD operating supply of 14V
to 28.8V. When the EVAL-AD74413R is connected to the PC, the PC powers
...
- EVAL-AD74413R evaluation board
- Maxim Board (MAX32655 or MAX78000)
