...
The DC2703A-A-KIT contains the DC2703A (LT8491 demo board) and DC1613A
(USB-to-I2C controller). Together they provide a high performance buck-boost
battery charger converter with an I2C interface. The LT8491 implements a maximum
power point tracking (MPPT) function and flexible charging profiles, suitable
for most battery types such as flooded and sealed lead  acid batteries and
Li-Ion batteries.
