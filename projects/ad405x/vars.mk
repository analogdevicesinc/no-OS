...
CARRIER_=$(strip $(CARRIER))
CARRIER_VALID=NUCLEO_H563ZI NUCLEO_H503RB

ifeq ($(CARRIER_), $(filter $(CARRIER_), $(CARRIER_VALID)))
CFLAGS += -D$(CARRIER_)
else
$(error Parameter CARRIER $(CARRIER_) is not valid. Valid values are $(CARRIER_VALID))
endif
