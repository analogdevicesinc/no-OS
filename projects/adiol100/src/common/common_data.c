...
static struct no_os_gpio_init_param irq_gpio_a_ip = {
	.port         = IRQA_PORT,
	.number       = IRQA_PIN,
	.pull         = NO_OS_PULL_UP,
...
static struct no_os_irq_init_param gpio_irq_ip = {
	.irq_ctrl_id  = IRQA_PORT,
	.platform_ops = GPIO_IRQ_OPS,
};

static struct no_os_irq_init_param nvic_ip = {
