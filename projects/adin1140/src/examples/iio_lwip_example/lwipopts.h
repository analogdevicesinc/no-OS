/*
 * Project-specific lwipopts.h for the adin1140 iio_lwip_example.
...
/* Reduced from 65536: the static heap array is the largest .bss consumer.
 * 16 KB is sufficient for a single IIO-over-TCP session. */
...
/* Reduced from 255: each slot is non-trivial; 4 is enough for IIO. */
