/*
 * Project-specific lwipopts.h for the iperf_lwip_adin1110 example
 * (apard32690 board, ADIN1110 / 10BASE-T1L). Tuned for iperf throughput;
 * overrides the shared libraries/lwip/configs/lwipopts.h via an early
 * -I in CFLAGS.
 */
