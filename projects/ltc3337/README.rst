...
- Low Power Primary Battery Powered Systems (e.g., 1× LiSOCl2, 
  2–3× Alkaline)
...
5.5V, supporting configurable peak currents up to 100mA. It draws a low
quiescent current of 100nA, making it suitable for battery-operated,
low-power applications. For optimal performance, the board should be
powered by a 5V supply with a minimum current capacity of 100mA. This
...
The DC2973A communicates via I2C/SMBus, so only SCL, SDA, and GND are
