...
The EV-ADF5902SD1Z is a microwave frequency synthesizer tailored for RF and
...
:git-no-OS:`Project Source Data Path </projects/adf5902_sdz/src>`.

Application Example
~~~~~~~~~~~~~~~~~~~

The application example for the EV-ADF5902SD1Z no-OS project demonstrates
