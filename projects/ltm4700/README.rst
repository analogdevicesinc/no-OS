...
This project is a IIOD demo for the MAX32665FTHR evaluation board. The project
...
* `DC2702B-A <https://www.analog.com/en/resources/evaluation-hardware-and-software/evaluation-boards-kits/dc2702b-a.html>`_
* `MAX32665FTHR <https://www.analog.com/en/resources/evaluation-hardware-and-software/evaluation-boards-kits/max32666fthr.html>`_

**Connections**:

+---------------------------+------------+-------------------------------+----------+-------------------------+
| DC2702B-A Pin             |  Mnemonic  | Function                      | Mnemonic | MAX32665FTHR Pin        |
+===========================+============+===============================+==========+=========================+
...
.. code-block:: bash
	...
	make TARGET=max32665 reset && make TARGET=max32665 clean
	# to build the project
	make TARGET=max32665
	# to flash the code
	make TARGET=max32665 run
