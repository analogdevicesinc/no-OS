...
.. code-block:: bash
	...
	python tools/scripts/no_os_build.py build \
	   --project ltm4700 --variant basic --board max32655fthr
...
.. code-block:: bash
	...
	python tools/scripts/no_os_build.py build \
	   --project ltm4700 --variant iio_example --board max32655fthr
...
+===========================+============+===============================+==========+=========================+
| E11 (SCL)                 | SCL        | PMBus/I2C Serial Clock        | I2C2_SCL | P0.30                   |
+---------------------------+------------+-------------------------------+----------+-------------------------+
| E12 (SDA)                 | SDA        | PMBus/I2C Serial Data         | I2C2_SDA | P0.31                   |
+---------------------------+------------+-------------------------------+----------+-------------------------+
