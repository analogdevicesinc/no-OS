...
Please see: `https://wiki.analog.com/resources/no-os/build`__
...
4. Connect the 12 V wall adapter to the ``J20`` input on the ZedBoard.
...
1. Clone the no-OS repository

   .. code-block:: bash

      git clone https://github.com/analogdevicesinc/no-OS.git

2. Navigate to the AD7768-EVB project

   .. code-block:: bash

      cd projects/ad7768-evb 

3. The project supports multiple platforms. Use this command to set the
   platform to ADuCM3029:

   .. code-block:: bash

      # Set the platform to ADuCM3029
      make PLATFORM=aducm3029 

4. Check and install Toolchain.

   -  For ADuCM3029, Analog Devices provides the GCC toolchain through the
      CrossCore Embedded Studio (CCES).

   -  Install or make sure you have:

         - Arm GNU Toolchain (arm-none-eabi-gcc) or
         - Analog Devices CCES toolchain

   -   Make sure the toolchain is in your PATH

5. Build the project. Inside the projects/ad7768-evb directory, run:
