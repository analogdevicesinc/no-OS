...
ifeq (y,$(strip $(CONFIG_SWIOT1L_DEFAULT_FW)))

IIOD=y
CFLAGS += -DCONFIG_SWIOT1L_DEFAULT_FW
...
ifeq (y,$(strip $(CONFIG_SWIOT1L_MQTT_EXAMPLE)))

ifndef CONFIG_SWIOT1L_MQTT_SERVER_IP
CONFIG_SWIOT1L_MQTT_SERVER_IP=192.168.97.1
endif

ifndef CONFIG_SWIOT1L_MQTT_SERVER_PORT
CONFIG_SWIOT1L_MQTT_SERVER_PORT=1883
endif

CFLAGS += -DCONFIG_SWIOT1L_MQTT_SERVER_IP=\"$(CONFIG_SWIOT1L_MQTT_SERVER_IP)\"
CFLAGS += -DCONFIG_SWIOT1L_MQTT_SERVER_PORT=$(CONFIG_SWIOT1L_MQTT_SERVER_PORT)

CFLAGS += -DCONFIG_SWIOT1L_MQTT_EXAMPLE
LIBRARIES += mqtt
