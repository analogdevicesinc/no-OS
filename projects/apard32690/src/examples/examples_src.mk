ifeq (y,$(strip $(CONFIG_APARD32690_ADIN1110_STANDALONE_EXAMPLE)))
CFLAGS += -DCONFIG_APARD32690_ADIN1110_STANDALONE_EXAMPLE
...
ifeq (y,$(strip $(CONFIG_APARD32690_ECHO_SERVER_EXAMPLE)))
CFLAGS += -DCONFIG_APARD32690_ECHO_SERVER_EXAMPLE
LIBRARIES += lwip
...
ifeq (y,$(strip $(CONFIG_APARD32690_BASIC_EXAMPLE)))
CFLAGS += -DCONFIG_APARD32690_BASIC_EXAMPLE
SRC_DIRS += $(PROJECT)/src/examples/basic_example
endif

ifeq (y,$(strip $(CONFIG_APARD32690_ESH_EXAMPLE)))
LIBRARIES += freertos
LIBRARIES += esh
FREERTOS_CONFIG_PATH = $(PROJECT)/src/FreeRTOSConfig.h
CFLAGS += -DCONFIG_APARD32690_ESH_EXAMPLE
