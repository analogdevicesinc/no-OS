...
#define DP83TG_BMSR						0x141
#define DP83TG_LINK_STATUS_MASK			NO_OS_BIT(2)

#define DP83TG_LSR						0x180
#define DP83TG_LINK_UP_MASK				NO_OS_BIT(15)

#define DP83TG_IO_CONTROL_1				0x454

#define DP83TG_SGMII_CTRL_1				0x608
...
#define DP83TG_SGMII_STATUS				0x60a
...
#define DP83TG_SGMII_CTRL_2				0x60c
#define DP83TG_MR_RESTART_AN_MASK		NO_OS_BIT(6)

#define DP83TG_PMA_PMD_CONTROL			0x1834
