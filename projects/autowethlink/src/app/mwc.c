		...
		.temp_correlation = {
			{
				...
				{HMC6301_LNA_ATTN_18dB, HMC6301_LNA_ATTN_12dB, HMC6301_LNA_ATTN_6dB, HMC6301_LNA_ATTN_0dB, HMC6301_LNA_ATTN_0dB} // rx lna_attn
			},
			{
				// hbtx
				{1, 3, 7, 15, 31},
				{15, 15, 15, 10, 0},
				{12, 12, 12, 12, 9},
				{HMC6301_LNA_ATTN_18dB, HMC6301_LNA_ATTN_12dB, HMC6301_LNA_ATTN_6dB, HMC6301_LNA_ATTN_0dB, HMC6301_LNA_ATTN_0dB}
			}
		},
