...
mykonosErr_t MYKONOS_initDigitalClocks(mykonosDevice_t *device)
{
    ...
    static const uint32_t vcoFreqArray_kHz[53] = {UINT32_C(12605000), UINT32_C(12245000), UINT32_C(11906000), UINT32_C(11588000), UINT32_C(11288000), UINT32_C(11007000), UINT32_C(10742000), UINT32_C(10492000), UINT32_C(10258000), UINT32_C(10036000),
            UINT32_C(9827800), UINT32_C(9631100), UINT32_C(9445300), UINT32_C(9269800), UINT32_C(9103600), UINT32_C(8946300), UINT32_C(8797000), UINT32_C(8655300), UINT32_C(8520600), UINT32_C(8392300), UINT32_C(8269900), UINT32_C(8153100), UINT32_C(8041400), UINT32_C(7934400),
            UINT32_C(7831800), UINT32_C(7733200), UINT32_C(7638400), UINT32_C(7547100), UINT32_C(7459000), UINT32_C(7374000), UINT32_C(7291900), UINT32_C(7212400), UINT32_C(7135500), UINT32_C(7061000), UINT32_C(6988700), UINT32_C(6918600), UINT32_C(6850600), UINT32_C(6784600),
            UINT32_C(6720500), UINT32_C(6658200), UINT32_C(6597800), UINT32_C(6539200), UINT32_C(6482300), UINT32_C(6427000), UINT32_C(6373400), UINT32_C(6321400), UINT32_C(6270900), UINT32_C(6222000), UINT32_C(6174500), UINT32_C(6128400), UINT32_C(6083600), UINT32_C(6040100),
            UINT32_C(5997700)};
