...
* `MAX22190 <https://www.analog.com/en/products/max22190.html>`_
...
.. code-block:: bash
	...
	python tools/scripts/no_os_build.py build \
	   --project max22190 --variant basic --board max32666fthr
...
.. code-block:: bash
	...
	python tools/scripts/no_os_build.py build \
	   --project max22190 --variant iio --board max32666fthr
...
.. code-block:: bash
   ...
   python tools/scripts/no_os_build.py build \
      --project max22190 --variant basic --board ad-apard32690-sl
